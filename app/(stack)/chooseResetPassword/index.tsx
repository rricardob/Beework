...
const ChooseResetPasswordScreen = () => {
    ...
    const radioButtonsData = useMemo(() => ([
        {
            ...
            label: 'Email a confirmation code to jo**********@gmail.com',
            value: 'email',
        ...
        {
            id: '2',
            label: 'Text a confirmation code to my phone ending in 65',
            value: 'phone',
            labelStyle: styles.radioLabel,
            containerStyle: styles.radioContainer,
        }
    ...
    return (
        ...
        <View className="flex-1 justify-between p-4">
            ...
            {/* Contenedor del botón */}
            <View className="justify-center items-center mb-20 mr-4">
                <Pressable
                    className={`py-3 px-6 rounded-lg text-base`}
                    onPress={() => {
                        router.push("/(stack)/findYourTwitterAccount");
                    }}
                >
                    <Text className="font-semibold text-[18px] text-center text-black underline">
                        Cancel
                    </Text>
                </Pressable>
            </View>
...
export default ChooseResetPasswordScreen;
